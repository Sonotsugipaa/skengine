...
//
// This file has been taken and marginally altered from https://github.com/peter-winter ,
// commit 18c56691324ecfb7eca07727b2c6d6c931866ed0.
    ...
    struct state_analyzer
    {
        ...
        constexpr void transitions(size16_t state_idx, size16_t symbol_idx, const situation_vector& symbol_situations)
        {
            ...
            if (entry.kind == parse_table_entry_kind::shift)
            {
                ...
                {
                    if (states[i].kernel.operator==(kernel))
                    {
                        new_state_idx = i;
                    }
                }
